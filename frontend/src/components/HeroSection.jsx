    ...
    return (
        <div className='text-center'>
            <div className='flex flex-col gap-5 my-12'>
                <span className='mx-auto px-4 py-2 rounded-full border border-border/40 bg-background/40 backdrop-blur text-accent font-medium shadow-[0_0_24px_rgba(99,102,241,0.25)]'>No. 1 Job Hunt Website</span>
                ...
                <p className='text-muted-foreground max-w-2xl mx-auto'>Discover curated roles tailored to you, with a modern experience and instant apply.</p>
