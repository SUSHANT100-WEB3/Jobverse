...
const Footer = () => {
  return (
    <footer className="border-t border-border/40 bg-background/60 backdrop-blur py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold bg-gradient-to-r from-fuchsia-400 via-indigo-400 to-cyan-300 bg-clip-text text-transparent">Jobverse</h2>
            <p className="text-sm text-muted-foreground">© 2025 Jobverse. All rights reserved.</p>
          </div>

          <div className="flex space-x-4 mt-4 md:mt-0 text-muted-foreground">
